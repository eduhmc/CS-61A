...
(if 0 (+ 7 3) (/ 1 0))
;expect 10
(cons (cons 1 nil) (cons 2 (cons (cons 3 (cons 4 (cons 5
  nil))) (cons 6 nil))))
;expect ((1) 2 (3 4 5) 6)
(define-macro (add-macro a1 a2)
  (list '+ a1 a2))
(add-macro 60 1)
;expect 61
(define (cs10-append lst1 lst2)
  (cond ((null? lst1) lst2)
  (else (cons (car lst1) (cs10-append (cdr lst1) lst2)))))
(cs10-append '(1 2 3) '(3 2 1))
;expect (1 2 3 3 2 1)
(define a 6)
((lambda (x y) (+ a)) 1 2)
;expect 6
...
(define (cs10-map func lst)
   (cond ((null? lst) nil)
   ((list? (car lst))
   (cons (cs10-map func (car lst))
   (cs10-map func (cdr lst))))
   (else (cons (func (car lst))
   (cs10-map func (cdr lst))))))
; expect cs10-map
(cs10-map (lambda (x) (* x x)) '(1 2 3))
; expect (1 4 9)
(cs10-map (lambda (x) (* x x)) '(1 (2 (3))))
; expect (1 (4 (9)))
