...
def make_joint(withdraw, old_password, new_password):
    ...
    def new_joint(amount, contraseña):
        if contraseña == new_password:
            return withdraw(amount, old_password)

        else:
            return withdraw(amount, contraseña) 
...
class Coin:
    ...
    def worth(self):
        "*** YOUR CODE HERE ***"
        bigger = Mint.current_year
        smaller = self.year 
        minus = bigger - smaller
        if minus > 50:
            return self.cents + (minus - 50)
        else:
            return self.cents
